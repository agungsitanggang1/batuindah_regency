            ...
            <?php echo form_open('blok/update',array('class'=>'form-horizontal form-groups-bordered','blok'=>'form'));  ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control" name="nama_blok" id="nama_blok" placeholder="Nama Blok" value="<?php echo isset($editdata->nama_blok) ? substr($editdata->nama_blok,5) : null; ?>" maxlength="1"  required/>
                    </div>
                </div>
                <div class="form-group">
