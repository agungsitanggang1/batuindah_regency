                        ...
                        <?php if(count($data) > 0){ ?>
                            <?php foreach($data as $key => $v): ?>
                                <tr>
                                    ...
                                    <td>
                                    <a href="<?php echo base_url('surat/print/'.$v->id_surat); ?>" class="btn btn-success btn-circle waves-effect waves-circle waves-float" rel="tooltip" title="Klik untuk ubah Agenda" target="_blank"><i class="entypo-print" ></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            <?php }else{ ?>
