        ...
        <div class="panel-body">            
            <?php echo form_open_multipart('dashboard/edit_profile_proses',array('accept-charset'=>"utf-8",'class'=>'form-horizontal form-groups-bordered','role'=>'form'));  ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="id" id="id" placeholder="ID" value="<?php echo isset($editdata->id_user_pemakai) ? $editdata->id_user_pemakai : null; ?>" />
