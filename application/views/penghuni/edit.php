...
<div class="col-md-12">        
    <div class="panel panel-primary" data-collapsed="0">
        ...
        <div class="panel-body">            
            <?php echo form_open_multipart('penghuni/update',array('class'=>'form-horizontal form-groups-bordered','blok'=>'form'));  ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input type="hidden" name="id_penghuni" id="id_penghuni" placholder="ID Rumah" value="<?php echo isset($editdata->id_penghuni) ? $editdata->id_penghuni : ''; ?>">
...
<!--                 <div class="form-group">
                ...
                <div id="anggota_keluarga">
                    ...
                    <table class="table table-bordered" id="tabel-keluarga">
                        ...
                        <tbody>
                            <?php
                            //echo '<pre>'; print_r($detail_anggota); echo '</pre>';
                            ...
                            <tr>
                                ...
                                <td style="width:15%;">
                                    <input id="anggota_<?php echo $key; ?>_no_ktp"  name="anggota[<?php echo $key; ?>][no_ktp]" type="text" class="form-control" value="<?php echo isset($detail->no_ktp) ? $detail->no_ktp : null; ?>" required>
                                </td>
                                <td style="width:18%">
                                    <select id="anggota_<?php echo $key; ?>_jeniskelamin" name="anggota[<?php echo $key; ?>][jeniskelamin]" class="form-control" required>
                                ...
                                <td style="width:12%">
                                    <input id="anggota_<?php echo $key; ?>_tanggal_lahir" name="anggota[<?php echo $key; ?>][tanggal_lahir]" type="text" class="form-control datepicker4" value="<?php echo isset($detail->tanggal_lahir) ? date('Y-m-d',strtotime($detail->tanggal_lahir)) : null; ?>">
                                </td>
                                <td style="width:20%">
                                    <select id="anggota_<?php echo $key; ?>_status" name="anggota[<?php echo $key; ?>][status]" class="form-control" required>
                                        <option value="">--Pilih--</option>
