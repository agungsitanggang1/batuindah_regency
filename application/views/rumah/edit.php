        ...
        <div class="panel-body">            
            <?php echo form_open('rumah/update',array('class'=>'form-horizontal form-groups-bordered','blok'=>'form'));  ?>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select class="form-control" name="id_blok2" id="id_blok2" disabled>
                        ...
                        <input type="hidden" name="id_blok" id="id_blok" value="<?php echo $editdata->id_blok ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="nama_pemilik" id="nama_pemilik" placeholder="Nama Pemilik" value="<?php echo isset($editdata->nama_pemilik) ? $editdata->nama_pemilik : ""; ?>" pattern="[a-zA-Z ]*" required/>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="number" class="form-control" name="no_rumah" id="no_rumah" placeholder="No. Rumah" value="<?php echo isset($editdata->no_rumah) ? $editdata->no_rumah : ""; ?>" readonly/>
                    </div>
                </div>
