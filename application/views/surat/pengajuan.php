        ...
        <div class="panel-body">            
            <?php echo form_open('Surat/insert',array('class'=>'form-horizontal form-groups-bordered','role'=>'form'));  ?>
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label">Digunakan Untuk</label>                    
                    <div class="col-sm-5">
                        <select class="form-control" name="subjek" id="subjek" required onchange="yesnoCheck(this);">
                            <option value="">-Pilih Subjek-</option>
                                <option value="Penghuni">Kepala Keluarga</option>
                ...
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label">Keperluan</label>                    
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="ket" id="ket" placeholder="Keterangan (Kosongkan jika tidak ada)"/>
                    </div>
                </div>
