            ...
            <?php foreach($data as $key => $v): ?>
                <tr>
                    ...
                    <td class="td-actions">
                        ...
                        <a href="<?php echo base_url('userPemakai/hapus/'.$v->id_user_pemakai); ?>" class="btn btn-danger btn-circle waves-effect waves-circle waves-float" rel="tooltip" title="Klik untuk hapus Agenda" onclick="return confirm('Apakah Anda Yakin Untuk Menghapus User Ini ?');"><i class="entypo-trash"></i></a>
