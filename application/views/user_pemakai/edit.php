        ...
        <div class="panel-body">            
            <?php echo form_open('userPemakai/update',array('class'=>'form-horizontal form-groups-bordered','role'=>'form'));  ?>
                <div class="form-group">
                    <label for="field-1" class="col-sm-3 control-label">Role <?= $editdata->id_role;?></label>                    
                    <div class="col-sm-5">
                        <select class="form-control" name="id_role" id="id_role" required>
                            ...
                            <?php 
                                ...
                                foreach ($role as $i => $val) { 
                                    ...
                                    if($editdata->id_role == '1'){
                            ?>
                                <option value="<?php echo 1; ?>" selected><?php echo "RT"; break; ?></option>
                            <?php }else if($editdata->id_role == '2'){ ?>
                             <option value="<?php echo 2 ?>" selected><?php echo "RW"; break; ?></option>
                            <?php } else{      
